...
internal static partial class Platform
{
	...
	public static nint FosterTextureCreate(int width, int height, TextureFormat format)
	{
		return new nint(Guid.NewGuid().GetHashCode());
	}

	public static unsafe void FosterTextureSetData(nint texture, void* data, int length)
	{

	}

	public static unsafe void FosterTextureGetData(nint texture, void* data, int length)
	{

	}

	public static void FosterTextureDestroy(nint texture)
	{

	}

	public static nint FosterTargetCreate(int width, int height, TextureFormat[] formats, int formatCount)
	{
		return new nint(Guid.NewGuid().GetHashCode());
	}

	public static nint FosterTargetGetAttachment(nint target, int index)
	{
		return new nint(Guid.NewGuid().GetHashCode());
	}

	public static void FosterTargetDestroy(nint target)
	{

	}

	public static nint FosterShaderCreate(ref FosterShaderData data)
	{
		return new nint(Guid.NewGuid().GetHashCode());
	}

	private static readonly FosterUniformInfo[] infos = [
		new() {
			index = 0,
	...
	public static unsafe void FosterShaderGetUniforms(IntPtr shader, FosterUniformInfo* output, out int count, int max)
	{
		count = infos.Length;
	...
	public static unsafe void FosterShaderSetUniform(IntPtr shader, int index, float* values)
	{

	}

	public static unsafe void FosterShaderSetTexture(IntPtr shader, int index, IntPtr* values)
	{

	}

	public static unsafe void FosterShaderSetSampler(IntPtr shader, int index, TextureSampler* values)
	{

	}

	public static void FosterShaderDestroy(IntPtr shader)
	{

	}

	public static nint FosterMeshCreate()
	{
		return new nint(Guid.NewGuid().GetHashCode());
	}

	public static void FosterMeshSetVertexFormat(nint mesh, ref FosterVertexFormat format)
	{

	}

	public static void FosterMeshSetVertexData(nint mesh, nint data, int dataSize, int dataDestOffset)
	{

	}

	public static void FosterMeshSetIndexFormat(nint mesh, IndexFormat format)
	{

	}

	public static void FosterMeshSetIndexData(nint mesh, nint data, int dataSize, int dataDestOffset)
	{

	}

	public static void FosterMeshDestroy(nint mesh)
	{

	}

	public static unsafe void FosterDraw(FosterDrawCommand* command)
	{

	}

	public static unsafe void FosterClear(FosterClearCommand* command)
	{
