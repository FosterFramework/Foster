...
/// </summary>
public struct StackList4<T> : IEnumerable<T>, IList<T>
{
	public const int TypeCapacity = 4;
	...
	public struct Enumerator(in StackList4<T> list) : IEnumerator<T>
	{
		private StackList4<T> list = list;
		private int index = -1;
